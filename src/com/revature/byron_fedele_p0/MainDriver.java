...
/* Fedele Bank is an application that simulates a simple baking application where you can sign up, log in, and make basic withdrawal and deposit transactions
*/
